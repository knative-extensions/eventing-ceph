...
import (
	...
	versionedscheme "knative.dev/eventing-ceph/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-ceph/pkg/client/injection/client"
	cephsource "knative.dev/eventing-ceph/pkg/client/injection/informers/sources/v1alpha1/cephsource"
...
const (
	...
	defaultFinalizerName       = "cephsources.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.CephSource"),
	)
