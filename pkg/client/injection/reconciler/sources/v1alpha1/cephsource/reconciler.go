...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.CephSource, desiredFinalizers sets.String) (*v1alpha1.CephSource, error) {
	// Don't modify the informers copy.
