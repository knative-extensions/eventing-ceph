...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.CephSource, desired *v1alpha1.CephSource) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.SourcesV1alpha1().CephSources(desired.Namespace)
		...
		updater := r.Client.SourcesV1alpha1().CephSources(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.CephSource, desiredFinalizers sets.Set[string]) (*v1alpha1.CephSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.CephSource, desiredFinalizers sets.Set[string]) (*v1alpha1.CephSource, error) {
	...
	patcher := r.Client.SourcesV1alpha1().CephSources(resource.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.CephSource, desiredFinalizers sets.Set[string]) (*v1alpha1.CephSource, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.CephSource, reconcileEvent reconciler.Event) (*v1alpha1.CephSource, error) {
	...
	if err != nil {
		...
		getter := r.Client.SourcesV1alpha1().CephSources(resource.Namespace)
